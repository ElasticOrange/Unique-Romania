...
@section('content')
    ...
    <div class="row background-red">
        <div class="col-xs-8">
            ...
            <p class="content-second text-white">Spuneţi-ne poveştile pe care le-aţi descoperit şi, la finalul călătoriei noastre, trei dintre voi vor primi ca premiu un echipament de iarnă pentru a pleca în vacanţă în destinaţiile speciale, pe care doriţi să le descoperiţi mai departe. Puteţi povesti despre locurile unice sau oamenii frumoşi prin texte, fotografii sau video-uri, voi alegeţi! Noi vom selecta câştigătorul care ne impresionează cel mai mult, din fiecare categorie. Alege-ţi categoria preferată şi uimeşte-ne!</p>
    ...
    <div class="row background-red">
        <div class="col-xs-4 text-white pull-right">
            <a href="http://www.canon.ro" class="link-white">www.canon.ro</a>
            <spam>|</spam>
